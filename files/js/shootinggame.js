        ...
        var shootinggamegame = {
            ...
            weaponloading(callback){
                ...
                window.setTimeout(function(){
                    shootinggamegame.objects.weaponparts.magazine.style.animation="loadingtomagazine 0.95s 1";
                },50);
                window.setTimeout(function(){
                    shootinggamegame.objects.weaponparts.magazine.src="./files/img/m1911_magazine_loaded.png";
                },400);
                window.setTimeout(function(){
                    shootinggamegame.objects.weaponparts.magazine.style.animation="";
                },1500);
                window.setTimeout(function () {
        ...
        document.getElementById("m1911pistolgr").onclick = function(e){
            if (shootinggamegame.inloadingtomagazine==false){
                ...
                if (shootinggamegame.rounds > 0) {
                    ...
                    if (shootinggamegame.rounds <= 0) {
                        shootinggamegame.objects.weaponparts.magazine.src = "./files/img/m1911_magazine.png";
                    }
        ...
        shootinggamegame.objects.weapon.addEventListener("focus", function(e0){
